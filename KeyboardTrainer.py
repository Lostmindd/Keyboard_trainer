...
class keyboard_trainer(QMainWindow):
    ...
    def delete_records_from_db(self, btn):
        if btn.text() == 'OK':
            language = "'" + self.current_language + "'"
            mac_address = "'" + str(get_mac_address()) + "'"
            self.execute_query('Delete from training_data where mac_address = ' + mac_address + ' and lanquage = ' + language + 'and difficulty = ' + str(
    ...
    def delete_records(self):
        ...
        warning.buttonClicked.connect(self.delete_records_from_db)
        warning.exec()
